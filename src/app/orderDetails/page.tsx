...
const Page = () => {
    ...
    return (
        <div className='w-full grid justify-center bg-white'>
                        ...
                        return (
                            <Fragment key={indx}>
                                {value?.order.map((data: any) => {
                                    return (
                                        <div className='gap-6 border-2 boder-black rounded-xl border-solid grid grid-cols-[20%_80%] h-[10rem] items-center m-2 ' key={data.id}>
